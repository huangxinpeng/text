      <!--应收账款转让申请-->
      <template>
        <div class="DebtAssignment" >
          <div class="" style="margin-bottom:20px;">
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <div class="col-md-12 textHeight">
                  <div class="col-md-12">
                    <span class="h4">定保理>应收账款转让申请</span>
      ...
      sum:0,
         ...
         methods:{
              ...
              quers:function(){
                ...
                this.url=selectsURL
                this.$http.post(this.url,JSON.stringify({pageSize:5,pageNumber:1,billsNo:this.selects.billsNo,custcdBuyer:this.selects.custcdBuyer,product:this.selects.product,billsAmountN:this.selects.billsAmountN,billsAmountM:this.selects.billsAmountM}), { headers:URL.headers },{emulateJSON:true}).then(function(response){
...
<style scoped>
.RtransferApply{width: 100%;overflow:  hidden}
