      <!--放款申请-->
      <template>
        <div class="LoanApplyMng" >
          <div class="" style="margin-bottom:20px;">
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <div class="col-md-12 textHeight">
                  <div class="col-md-12">
                    <span class="h4">池保理>融资申请</span>
  ...
  data(){
    return{
          ...
          created(){
            ...
            this.url=redayUrl
            this.$http.post(redayUrl,JSON.stringify(this.querys),{headers:URL.headers }).then(function(response){
...
getApply:function(){
      ...
      // this.url=applyUrl
      this.$http.post(applyUrl,JSON.stringify(this.loanArr), {headers:URL.headers }).then(function(response){
...
<style scoped>
.LoanApplyMng{width: 100%;overflow: hidden;}
